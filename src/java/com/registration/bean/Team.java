...
public class Team {
    ...
    public Team(int teamID, String teamName, String coachIC, String orgUsername, String orgPassword, String orgStatus,
            int createdBy) {
        this.teamID = teamID;
        this.teamName = teamName;
        this.coachIC = coachIC;
    ...
    public void addTeamWithOrg(String teamName, String coachIC, String orgUsername, String orgPassword, int createdBy)
            throws SQLException {
    ...
    public boolean orgLogin(String username, String password) throws SQLException {
        pstm = con.prepareStatement(
                "SELECT teamID FROM TEAM WHERE orgUsername = ? AND orgPassword = ? AND orgStatus = 'active'");
