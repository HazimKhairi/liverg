                            ...
                            <body>
                                    ...
                                    <div class="dashboard-content">
                                        <div class="data-card">
                                            <div class="data-card-header">
                                                ...
                                                <% if (userRole.equals("clerk") || userRole.equals("superadmin") ||
                                                    userRole.equals("organization") || userRole.equals("staff")) { %>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><i class="fas fa-plus-circle"></i> Add Event
                                                </h5>
                                                ...
                                                <form id="addEventForm">
                                                    ...
                                                    <% if (userRole.equals("superadmin") || userRole.equals("staff")) {
                                                        ...
                                                        <% } else if (userRole.equals("clerk")) { %>
                                                            ...
                                                            <% } else if (userRole.equals("organization")) { Integer
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="updateEventForm">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Event Date</label>
                                                        <input type="date" name="updateEventDate" id="updateEventDate"
                                                            class="form-control">
                                                    </div>
                                                </form>
                                            </div>
                                ...
                                <script>
                                    ...
                                    function renderEvents(data) {
                                        ...
                                        $.each(paginatedData, function (index, event) {
