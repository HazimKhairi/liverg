                ...
                <%@ page import="com.registration.bean.*" %>
                    <%@ page import="com.connection.DBConnect" %>
                        ...
                        <% String userRole=(String) session.getAttribute("userRole"); Integer staffID=(Integer)
                            session.getAttribute("staffID"); Integer clerkID=(Integer) session.getAttribute("clerkID");
                            String userName=(String) session.getAttribute("userName"); if (userName==null)
                            userName="User" ; if (userRole==null) { response.sendRedirect("../LogoutServlet"); return; }
                            %>
                            ...
                            <body>
                                ...
                                <main class="dashboard-main">
                                            ...
                                            <div class="data-card-header">
                                                ...
                                                <% if (staffID==null) { %>
                                                    <button class="btn-add" data-bs-toggle="modal"
                                                        data-bs-target="#addHeadjudgeModal">
                                    ...
                                    <footer class="dashboard-footer">
                                        <p style="margin: 0;">&copy; 2026 LIVERG Gymnastics Scoring System. All rights
                                            reserved.</p>
                                    </footer>
                                </main>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><i class="fas fa-user-plus"></i> Add Head Judge
                                                </h5>
                                ...
                                <div class="modal fade" id="updateHeadjudgeModal" tabindex="-1">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"><i class="fas fa-edit"></i> Update Head Judge
                                                </h5>
                                                <button type="button" class="btn-close"
                                                    data-bs-dismiss="modal"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form id="ajaxUpdateHeadjudge">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Username</label>
                                                        <input type="text" name="updateHeadjudgeName"
                                                            id="updateHeadjudgeName" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Password</label>
                                                        <div class="input-group">
                                                            <input type="password" name="updateHeadjudgePassword"
                                                                id="updateHeadjudgePassword" class="form-control">
                                                            <span class="input-group-text"
                                                                onclick="togglePassword('updateHeadjudgePassword', this)">
                                                                <i class="bi bi-eye"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="form-label">Confirm Password</label>
                                                        <input type="password" name="updateConfirmPassword"
                                                            id="updateConfirmPassword" class="form-control">
                                                    </div>
                                                    <input type="hidden" name="updateheadjudgeID"
                                                        id="updateheadjudgeID">
                                                </form>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn-modal btn-modal-secondary"
                                                    data-bs-dismiss="modal">Cancel</button>
                                                <button type="button" class="btn-modal btn-modal-primary"
                                                    onclick="validateAndUpdateHeadjudge()">
                                ...
                                <script>
                                    ...
                                    function renderHeadJudges(data) {
                                        ...
                                        if (data.length === 0) {
                                            ...
                                            $.each(paginatedData, function (index, head) {
                                                var row = '<tr>' +
