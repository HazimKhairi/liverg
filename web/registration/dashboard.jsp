                ...
                <%@ page import="jakarta.servlet.http.*" %>
                    <%@ page import="com.registration.bean.*" %>
                        <%@ page import="com.connection.DBConnect" %>
                            ...
                            <% Connection con=null; Statement stmt=null; ResultSet rs=null; List<Clerk> clerks = new
                                ArrayList<>();
                                    int judgeCount = 0;
                                    int clerkCount = 0;
                                    int headCount = 0;
                                    ...
                                    List<Gymnast> gymnasts = new ArrayList<>();
                                            List<Apparatus> apparatusList = new ArrayList<>();
                                                    List<Team> teams = new ArrayList<>();
                                                            ...
                                                            String query = "SELECT G.GYMNASTID, G.GYMNASTIC, G.GYMNASTNAME, G.GYMNASTSCHOOL, G.GYMNASTCATEGORY, " +
                                                            "GROUP_CONCAT(A.APPARATUSNAME ORDER BY A.APPARATUSNAME SEPARATOR ', ') AS APPARATUS_LIST, " +
                                                            "T.TEAMNAME FROM GYMNAST G " +
                                                            "JOIN GYMNAST_APP GA ON G.GYMNASTID = GA.GYMNASTID " +
                                                            "JOIN APPARATUS A ON GA.APPARATUSID = A.APPARATUSID " +
                                                            "JOIN TEAM T ON G.TEAMID = T.TEAMID GROUP BY G.GYMNASTID, G.GYMNASTNAME";
                                                            ...
                                                            Map<String, List<Gymnast>> gymnastsByTeam =
                                                                gymnasts.stream().collect(Collectors.groupingBy(g -> {
                                                                ...
                                                                <head>
                                                                    ...
                                                                    <!-- Custom Theme -->
                                                                    <link rel="stylesheet"
                                                                        href="../assets/css/liverg-theme.css">
                                                                    ...
                                                                    <aside class="dashboard-sidebar" id="sidebar">
                                                                        <div class="sidebar-header">
                                                                            <a href="dashboard.jsp"
                                                                                class="sidebar-logo">
                                                                                <img src="../assets/img/liverg-logo.png" alt="LIVERG" style="height: 40px;">
                                                                            </a>
                                                                        </div>

                                                                        <nav class="sidebar-nav">
                                                                            <div class="sidebar-section">
                                                                                <div class="sidebar-section-title">Main
                                                                                    Menu</div>
                                                                            </div>
                                                                            <a href="dashboard.jsp"
                                                                            ...
                                                                            <% if (userRole.equals("superadmin") ||
                                                                                ...
                                                                                <a href="headDetails.jsp"
                                                                                    class="sidebar-nav-item">
                                                                                    <i class="fas fa-user-tie"></i>
                                                                                    <span>Head Judges</span>
                                                                                </a>
                                                                                <a href="judgesDetails.jsp"
                                                                                    class="sidebar-nav-item">
                                                                                ...
                                                                                <% } %>
                                                                                    ...
                                                                                    <a href="teamDetails.jsp"
                                                                                        class="sidebar-nav-item">
                                                                                        <i class="fas fa-users"></i>
                                                                                        <span>Teams</span>
                                                                                    </a>
                                                                                    <a href="gymnastDetails.jsp"
                                                                                        class="sidebar-nav-item">
                                                                    ...
                                                                    <main class="dashboard-main">
                                                                        ...
                                                                        <div class="dashboard-content">
                                                                            ...
                                                                            <div class="welcome-banner">
                                                                                ...
                                                                                <p>Here's what's happening with your
                                                                                    gymnastics scoring system today.
                                                                                    Monitor competitions, manage teams,
                                                                                    and track scores all in one place.
                                                                                </p>
                                                                                ...
                                                                                <div class="stat-card cyan">
                                                                                    <div class="stat-card-header">
                                                                                        <div>
                                                                                            ...
                                                                                            <div
                                                                                                class="stat-card-change positive">
                                                                                                <i
                                                                                ...
                                                                                <div class="data-card-header">
                                                                                    <h3 class="data-card-title">
                                                                                        <i class="fas fa-users"
                                                                                            style="color: #00d4aa;"></i>
                                                                                        Team & Gymnast Overview
                                                                                    </h3>
                                                                                    <a href="gymnastDetails.jsp"
                                                                                        class="btn btn-sm"
                                                                                        style="background: linear-gradient(135deg, #00d4aa, #1a3a5c); color: white; border-radius: 0.5rem;">
                                                                                ...
                                                                                <div class="data-card-body">
                                                                                    <% if (gymnastsByTeam.isEmpty()) {
                                                                                        ...
                                                                                        <div class="empty-state">
                                                                                            ...
                                                                                            <p>Start by adding teams and
                                                                                                gymnasts to see them
                                                                                                here.</p>
                                                                                            <a href="teamDetails.jsp"
                                                                                                class="btn mt-3"
                                                                                                style="background: linear-gradient(135deg, #00d4aa, #1a3a5c); color: white;">
                                                                                                <i
                                                                                                         ...
                                                                                                         <% 
                                                                                                            try {
                                                                                                                ...
                                                                                                                for (Map.Entry<String, List<Gymnast>> entry : gymnastsByTeam.entrySet()) {
                                                                                                                    ...
                                                                                                                    List<Gymnast> teamGymnasts = entry.getValue();
                                                                                                            %>
                                                                                                            <tr>
                                                                                                                <td colspan="5">
                                                                                                                    <span class="team-badge">
                                                                                                                        <i class="fas fa-users"></i>
                                                                                                                        <%= teamName != null ? teamName : "Unknown Team" %>
                                                                                                                        <span style="opacity: 0.7; font-weight: 400;">(<%= teamGymnasts != null ? teamGymnasts.size() : 0 %> gymnasts)</span>
                                                                                                                    </span>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <% 
                                                                                                                if (teamGymnasts != null) {
                                                                                                                    for (Gymnast gymnast : teamGymnasts) { 
                                                                                                                        int index = gymnasts.indexOf(gymnast);
                                                                                                                        Apparatus apparatus = (index >= 0 && index < apparatusList.size()) ? apparatusList.get(index) : new Apparatus();
                                                                                                            %>
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <div style="display: flex; align-items: center; gap: 0.75rem;">
                                                                                                                            <div style="width: 36px; height: 36px; border-radius: 50%; background: linear-gradient(135deg, #e91e8c, #8b5cf6); display: flex; align-items: center; justify-content: center; color: white; font-weight: 600; font-size: 0.875rem;">
                                                                                                                                <% if (gymnast.getGymnastName() != null && !gymnast.getGymnastName().isEmpty()) { %>
                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div style="font-weight: 600; color: #1a3a5c;">
                                                                                                                                    <%= gymnast.getGymnastName() != null ? gymnast.getGymnastName() : "Unknown Name" %>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                    <td><%= gymnast.getGymnastIC() != null ? gymnast.getGymnastIC() : "-" %></td>
                                                                                                                    <td><%= gymnast.getGymnastSchool() != null ? gymnast.getGymnastSchool() : "-" %></td>
                                                                                                                    <td>
                                                                                                                        <span class="category-badge"><%= gymnast.getGymnastCategory() != null ? gymnast.getGymnastCategory() : "-" %></span>
                                                                                                                        <div class="apparatus-list mt-1"><%= apparatus.getApparatusName() != null ? apparatus.getApparatusName() : "-" %></div>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                            <% 
                                                                                                                    }
                                                                                                                ...
                                                                                                                out.println("<tr><td colspan='5' style='color:red'>Error rendering table: " + e.toString() + "</td></tr>");
                                                                        ...
                                                                        <!-- Footer -->
                                                                        <footer
                                                                            style="padding: 1.5rem 2rem; text-align: center; color: #64748b; font-size: 0.875rem; border-top: 1px solid #e2e8f0; background: white;">
                                                                            <p style="margin: 0;">&copy; 2026 LIVERG
                                                                                Gymnastics Scoring System. All rights
                                                                                reserved.</p>
                                                                        </footer>
                                                                    </main>
                                                                    ...
                                                                    <script>
                                                                        ...
                                                                        $(document).ready(function () {
                                                                            ...
                                                                            if (totalRows > rowsPerPage) {
                                                                                ...
                                                                                paginationDiv.className = 'd-flex justify-content-center mt-4 mb-2 gap-2 text-center';
                                                                                ...
                                                                                function renderControls() {
                                                                                    ...
                                                                                    prevBtn.className = 'btn btn-sm btn-light border';
                                                                                    ...
                                                                                    info.className = 'align-self-center mx-3 text-muted small';
                                                                                    info.innerText = 'Page ' + currentPage + ' of ' + totalPages;
                                                                                    
                                                                                    const nextBtn = document.createElement('button');
                                                                                    nextBtn.className = 'btn btn-sm btn-light border';
