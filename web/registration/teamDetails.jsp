    ...
    <%@ page import="jakarta.servlet.http.*" %>
        <%@ page import="java.io.*" %>
            <%@ page import="java.sql.*" %>
                ...
                <% String userRole=(String) session.getAttribute("userRole"); Integer staffID=(Integer)
                    session.getAttribute("staffID"); String userName=(String) session.getAttribute("userName"); if
                    (userName==null) userName="User" ; if (userRole==null) { response.sendRedirect("../LogoutServlet");
                    return; } %>
                    ...
                    <body>
                        ...
                        <main class="dashboard-main">
                                ...
                                <div class="header-right">
                                    ...
                                    <div class="user-dropdown dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item text-danger" href="../LogoutServlet"><i
                            ...
                            <footer class="dashboard-footer">
                                <p style="margin: 0;">&copy; 2026 LIVERG Gymnastics Scoring System. All rights reserved.
                                </p>
                            </footer>
                        </main>
                                    ...
                                    <div class="modal-body">
                                        <form id="addTeamForm">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="coachName" id="coachName"
                                                            class="form-control" placeholder="Enter coach name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Coach IC</label>
                                                        <input type="text" name="coachIC" id="coachIC"
                                                            class="form-control" placeholder="Enter IC number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Coach Place of Duty</label>
                                                <input type="text" name="coachPOD" id="coachPOD" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="fisioName" id="fisioName"
                                                            class="form-control" placeholder="Enter fisio name">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Fisio IC</label>
                                                        <input type="text" name="fisioIC" id="fisioIC"
                                                            class="form-control" placeholder="Enter IC number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fisioPOD" id="fisioPOD" class="form-control"
                                                    placeholder="Enter place of duty">
                                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                <div class="modal-content">
                                        ...
                                        <form id="updateTeamForm">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Coach Name</label>
                                                        <input type="text" name="updateCoachName" id="updateCoachName"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Coach IC</label>
                                                        <input type="text" name="updateCoachIC" id="updateCoachIC"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Coach Place of Duty</label>
                                                <input type="text" name="updateCoachPOD" id="updateCoachPOD"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Fisio Name</label>
                                                        <input type="text" name="updateFisioName" id="updateFisioName"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="form-label">Fisio IC</label>
                                                        <input type="text" name="updateFisioIC" id="updateFisioIC"
                                                            class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Fisio Place of Duty</label>
                                                <input type="text" name="updateFisioPOD" id="updateFisioPOD"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="form-label">Team Name</label>
                                                <input type="text" name="updateTeamName" id="updateTeamName"
                                                    class="form-control">
                                            </div>
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn-modal btn-modal-secondary"
                                            data-bs-dismiss="modal">Cancel</button>
                                        <button type="button" class="btn-modal btn-modal-primary"
                                            onclick="updateTeam()">
                        ...
                        <script>
                            ...
                            function renderTeams(data) {
                                ...
                                $.each(paginatedData, function (index, team) {
                                    ...
                                    var row = '<tr>' +
                                        '<td><div class="row-number">' + (start + index + 1) + '</div></td>' +
                                        '<td>' +
