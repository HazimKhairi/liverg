...
if (userRole==null) {
                                    response.sendRedirect("../LogoutServlet"); return; } Connection con=null; Statement
                                    stmt=null; ResultSet rs=null; List<Team> teams = new ArrayList<>();
                                        List<Apparatus> apparatusList = new ArrayList<>();
                                                List<Event> eventList = new ArrayList<>();
                                                        ...
                                                        <body>
                                                            ...
                                                            <aside class="dashboard-sidebar" id="sidebar">
                                                                ...
                                                                <nav class="sidebar-nav">
                                                                    <div class="nav-section">
                                                                        ...
                                                                        <a href="dashboard.jsp"><i
                                                                                class="fas fa-th-large"></i>
                                                                            Dashboard</a>
                                                                    </div>

                                                                    <% if ("superadmin".equals(userRole) || "staff"
                                                                        .equals(userRole)) { %>
                                                                        <div class="nav-section">
                                                                            <div class="nav-section-title">Management
                                                                            </div>
                                                                            <a href="headDetails.jsp"><i
                                                                                    class="fas fa-user-tie"></i> Head
                                                                                Judges</a>
                                                                            <a href="judgesDetails.jsp"><i
                                                                                    class="fas fa-gavel"></i> Judges</a>
                                                                        </div>
                                                                        <% } %>
                                                                            ...
                                                                            <div class="nav-section">
                                                                                <div class="nav-section-title">
                                                                                    Competitions</div>
                                                                                <a href="eventDetails.jsp"><i
                                                                                        class="fas fa-calendar-alt"></i>
                                                                                    Events</a>
                                                                                <a href="teamDetails.jsp"><i
                                                                ...
                                                                <header class="dashboard-header">
                                                                    ...
                                                                    <div class="header-actions">
                                                                        ...
                                                                        <div class="user-avatar">
                                                                            <%= userRole !=null ? userRole.substring(0,
                                                                                1).toUpperCase() : "U" %>
                                                                        </div>
                                                                    </div>
                                                                </header>
                                                                ...
                                                                <div class="content-area">
                                                                    ...
                                                                    <div class="table-card">
                                                                        <div class="table-card-header">
                                                                            <h3><i
                                                                                    class="fas fa-running me-2"></i>Gymnast
                                                                                List</h3>
                                                                            <% if (staffID==null) { %>
                                                                                <button class="btn-add"
                                                                                    data-bs-toggle="modal"
                                                                                    data-bs-target="#AddGymnastModal">
                                                            ...
                                                            <!-- Add Gymnast Modal -->
                                                            <div class="modal fade" id="AddGymnastModal" tabindex="-1"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><i
                                                                                    class="fas fa-user-plus me-2"></i>Add
                                                                                New Gymnast</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="ajaxAddGymnast"
                                                                                enctype="multipart/form-data">
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">Gymnast
                                                                                            Name</label>
                                                                                        <input type="text"
                                                                                            name="gymnastName"
                                                                                            id="gymnastName"
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        ...
                                                                                        <select name="gymnastCategory"
                                                                                            id="gymnastCategory"
                                                                                            class="form-select">
                                                                                            <option value="" hidden>
                                                                                                Select Category</option>
                                                                                            <option value="U12">U12
                                                                                            </option>
                                                                                            <option value="U9">U9
                                                                                            </option>
                                                                                        </select>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">Apparatus
                                                                                            (Multiple)</label>
                                                                                        <select name="select2"
                                                                                            id="select2"
                                                                                            class="form-select"
                                                                                            multiple>
                                                                                            <% for (Apparatus apparatus
                                                                                                : apparatusList) { %>
                                                                                                <option
                                                                                                    value="<%= apparatus.getApparatusID() %>">
                                                                                                    <%= apparatus.getApparatusName()
                                                                                                        %>
                                                                                                </option>
                                                                                                <% } %>
                                                                                        </select>
                                                            ...
                                                            <div class="modal fade" id="updateGymnastModal"
                                                                tabindex="-1" aria-hidden="true">
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><i
                                                                                    class="fas fa-edit me-2"></i>Update
                                                                                Gymnast</h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form id="ajaxUpdateGymnast"
                                                                                enctype="multipart/form-data">
                                                                                <input type="hidden"
                                                                                    name="updateGymnastID"
                                                                                    id="updateGymnastID">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            ...
                                                                                            Name</label>
                                                                                        <input type="text"
                                                                                            name="updateGymnastName"
                                                                                            id="updateGymnastName"
                                                                                            class="form-control">
                                                                                    </div>
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label class="form-label">IC
                                                                                            Picture (Leave empty to keep
                                                                                            current)</label>
                                                                                        <input type="file"
                                                                                            class="form-control"
                                                                                            name="updateGymnastPic"
                                                                                            id="updateGymnastPic"
                                                                                            accept="image/*">
                                                                                    </div>
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">School</label>
                                                                                        <input type="text"
                                                                                            name="updateGymnastSchool"
                                                                                            id="updateGymnastSchool"
                                                                                            class="form-control">
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">Category</label>
                                                                                        <select
                                                                                            name="updateGymnastCategory"
                                                                                            id="updateGymnastCategory"
                                                                                            class="form-select">
                                                                                            <option value="U12">U12
                                                                                            </option>
                                                                                            <option value="U9">U9
                                                                                    ...
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">Team</label>
                                                                                        <select name="updateGymnastTeam"
                                                                                            id="updateGymnastTeam"
                                                                                            class="form-select">
                                                                                            <option value="" hidden>
                                                                                                Select Team</option>
                                                                                            <% for (Team team : teams) {
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            class="form-label">Event</label>
                                                                                        <select
                                                                                            name="updateGymnastEvent"
                                                                                            id="updateGymnastEvent"
                                                                                            class="form-select">
                                                                                            <option value="" hidden>
                                                                                                Select Event</option>
                                                                                            <% for (Event event :
                                                                                    ...
                                                                                    <div class="col-md-6 mb-3">
                                                                                        <label
                                                                                            ...
                                                                                            Apparatus</label>
                                                                                        <div id="apparatusValuesContainer"
                                                                                            class="mb-2"></div>
                                                                                        <label class="form-label">New
                                                                                            Apparatus (Multiple)</label>
                                                                                        <select name="select3"
                                                                                            id="select3"
                                                                                            class="form-select"
                                                                                            multiple>
                                                            ...
                                                            <div class="modal fade" id="imageModal" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"><i
                                                                                    class="fas fa-id-card me-2"></i>Identity
                                                                                Card Image</h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bg-danger text-white"
                                                                            style="background: linear-gradient(135deg, #dc3545 0%, #b02a37 100%) !important;">
                                                                            <h5 class="modal-title"><i
                                                                                    class="fas fa-exclamation-triangle me-2"></i>Confirm
                                                                                Delete</h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"
                                                                                aria-label="Close"></button>
                                                                        ...
                                                                        <div class="modal-body text-center py-4">
                                                                            ...
                                                                            <h5>Are you sure?</h5>
                                                                            <p class="text-muted">This action cannot be
                                                                                undone. The gymnast will be permanently
                                                                                deleted.</p>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn-cancel"
                                                            ...
                                                            <script>
                                                                ...
                                                                function renderGymnasts(data) {
                                                                    ...
                                                                    $.each(paginatedData, function (index, gymnast) {
                                                                        var row = $('<tr>');

                                                                        // Row number
                                                                        row.append($('<td>').text(start + index + 1));
                                                        ...
                                                        <% } catch (SQLException e) { e.printStackTrace(); } finally {
                                                            try { if (rs !=null) rs.close(); if (stmt !=null)
                                                            stmt.close(); if (con !=null) con.close(); } catch
