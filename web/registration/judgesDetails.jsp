                ...
                <%@ page import="com.connection.DBConnect" %>
                    <%@ page import="com.registration.bean.Team" %>
                        ...
                        <% String userRole=(String) session.getAttribute("userRole"); if (userRole==null) {
                            response.sendRedirect("../LogoutServlet"); return; } String userName=(String)
                            session.getAttribute("userName"); if (userName==null) userName="User" ; Connection con=null;
                            Statement stmt=null; ResultSet rs=null; List<Team> teams = new ArrayList<>();
                                ...
                                <body>
                                    ...
                                    <main class="dashboard-main">
                                        ...
                                        <footer class="dashboard-footer">
                                            <p style="margin: 0;">&copy; 2026 LIVERG Gymnastics Scoring System. All
                                                rights reserved.</p>
                                        </footer>
                                    </main>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><i class="fas fa-user-plus"></i> Add Judge
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <form id="addJudgeForm">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="judgeName" id="judgeName"
                                                                class="form-control" placeholder="Enter judge name">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Identity Card</label>
                                                            <input type="text" name="judgeIC" id="judgeIC"
                                                                class="form-control" placeholder="Enter IC number">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Place of Duty</label>
                                                            <input type="text" name="judgePOD" id="judgePOD"
                                                                class="form-control" placeholder="Enter place of duty">
                                                        </div>
                                                        <div class="form-group">
                                    ...
                                    <div class="modal fade" id="updateJudgeModal" tabindex="-1">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"><i class="fas fa-edit"></i> Update Judge
                                                    </h5>
                                                    <button type="button" class="btn-close"
                                                        data-bs-dismiss="modal"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="updateJudgeForm">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="form-label">Judge Name</label>
                                                            <input type="text" name="updateJudgeName"
                                                                id="updateJudgeName" class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Identity Card</label>
                                                            <input type="text" name="updateJudgeIC" id="updateJudgeIC"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Place of Duty</label>
                                                            <input type="text" name="updateJudgePOD" id="updateJudgePOD"
                                                                class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Team</label>
                                                            <select name="updateJudgeTeam" id="updateJudgeTeam"
                                                                class="form-select">
                                                                <option value="" hidden>Select a Team</option>
                                                                <% for (Team team : teams) { %>
                                                                    <option value="<%= team.getTeamID() %>">
                                    ...
                                    <script>
                                        ...
                                        function renderJudges(data) {
                                            ...
                                            $.each(paginatedData, function (index, judge) {
                                        ...
                                        function renderPagination(totalItems) {
                                            ...
                                            var prevBtn = $('<button>')
                                                ...
                                                .click(function() {
                                                    if (currentPage > 1) {
                                                        currentPage--;
                                                        renderJudges(allJudges); // Re-render with current full data
                                                    }
                                                });
                                    ...
                                    <% } catch (SQLException e) { e.printStackTrace(); } finally { try { if (rs !=null)
                                        rs.close(); if (stmt !=null) stmt.close(); if (con !=null) con.close(); } catch
