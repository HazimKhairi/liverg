        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                .status-pill.scoring .dot {
                    background: var(--warning);
                    animation: pulse 1s infinite;
                }

                .status-pill.submitted .dot {
                ...
                .score-cell.pending .code {
                    color: var(--text-muted);
                }

                .score-cell.submitted .code {
                    color: var(--success);
                }
                    ...
                    <div id="activeSession" style="flex: 1; display: flex; flex-direction: column;">
                        ...
                        <div class="scores-container">
                            ...
                            <div class="panel-section">
                                ...
                                <div class="scores-grid" id="penaltyGrid"></div>
                            </div>
                        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="scoreInputValue" class="form-label text-muted small"
                                    id="scoreModalLabel">Score Value (0.00 - 10.00)</label>
                                <input type="number" class="form-control form-control-lg text-center fw-bold"
                                    id="scoreInputValue" step="0.001" min="0" max="10" placeholder="0.00">
                            </div>
                        </div>
            ...
            <script>
                ...
                $(document).ready(function () {
                    ...
                    var positions = [
                        ...
                        { positionCode: 'L1', positionName: 'Line Penalty', category: 'LINE', panelNumber: 1 },
                        { positionCode: 'T1', positionName: 'Time Penalty', category: 'TIME', panelNumber: 1 },
                        { positionCode: 'RJ', positionName: 'Technical Penalty', category: 'RJ', panelNumber: 1 }
                    ];
                    ...
                    function handleSessionState(data) {
                        ...
                        if (data.finalScore) {
                            ...
                            // Already handled by preview calc if finalScore is missing, but if status is NOT active/submitted
                            // If status IS active, then preview won't run, but finalScore IS present.
                            // If NO_SESSION, all reset.
                        }
                        ...
                        if (status === 'NO_SESSION') {
                            ...
                            $('#btnForceSubmit').prop('disabled', status !== 'SCORING');
                    ...
                    function calculateAndDisplayPreview(scores) {
                        ...
                        // Display if not officially finalized
                        if (!$('#sessionStatus').hasClass('active') && !$('#sessionStatus').hasClass('submitted')) {
