   ...
   <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
      ...
      <li class="nav-item ">
       <a class="nav-link bg-primary text-white" href="EventAdmin" aria-expanded="false" aria-controls="">
...
//                                      }
      ...
      <footer class="footer">
       <div class="d-sm-flex justify-content-center justify-content-sm-between">
        ...
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Hand-crafted & made with <i class="ti-heart text-danger ml-1"></i></span>
               ...
               <input type="hidden" value="<%= request.getParameter("eventID") %>" id="eventID">
 ...
 let eventID = document.getElementById("eventID").value;
        ...
        for (const gymnast of gymnastDataArray) {
         ...
         actionCell.innerHTML = '<a href="LiveScoringAdminTable?gymnastID=' + gymnast.gymnastID + '&eventID='+eventID+'">info > </a>';
      ...
      <script>
       ...
       $("#categoryName").on("change", function () {
        ...
        $.ajax({
         ...
         url: 'LiveScoringAdmin?eventID=' + eventID,
