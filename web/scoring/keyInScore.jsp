   ...
   <div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <ul class="nav">
      ...
      <li class="nav-item">
       <a class="nav-link" href="EventAdmin" aria-expanded="false" aria-controls="tables">
              ...
              <div class="modal-body">
               <form id="addGymnastForm" action="updateScore" method="post">    
                ...
                <div class="form-group">
                 ...
                 <input type="number" class="form-control"step=any name="scoreD1" id="scoreD1" required>
                </div>
                ...
                <div class="form-group">
                 ...
                 <input type="number" class="form-control"step=any name="scoreA1" id="scoreA1" required>
                </div>
                <div class="form-group">
                 <label for="name" class="col-form-label">Score A2:</label>
                 <input type="number" class="form-control"step=any name="scoreA2" id="scoreA2" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <select class="form-control text-dark" name="judgeID">
                  <option hidden disabled value="">Please Select Judge</option>
                  <%
