...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand .live { color: var(--primary-cyan); }
        .brand .rg { color: var(--primary-magenta); }
        ...
        .page-title i { color: var(--primary-cyan); }
        ...
        .start-list-item:hover .drag-handle { opacity: 1; }
        ...
        .item-score.pending { color: var(--text-muted); }
        ...
        .sidebar .card:last-child { flex: 1; min-height: 0; }
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btnAddGymnast').on('click', function() {
                Swal.fire({
                    title: 'Add Gymnast to Start List',
                    html:
                        '<div style="text-align:left;margin-bottom:12px;">' +
                        '<label style="font-size:12px;color:#64748b;font-weight:600;">Apparatus</label>' +
                        '<select id="swalApparatus" class="swal2-select" style="width:100%;margin-top:5px;border:1px solid #e2e8f0;border-radius:0.5rem;">' +
                        '<option value="">Select apparatus...</option>' +
                        apparatus.map(function(a) { return '<option value="' + a.apparatusID + '">' + a.apparatusName + '</option>'; }).join('') +
                        '</select>' +
                        '</div>' +
                        '<div style="text-align:left;margin-bottom:12px;">' +
                        '<label style="font-size:12px;color:#64748b;font-weight:600;">Day</label>' +
                        '<select id="swalDay" class="swal2-select" style="width:100%;margin-top:5px;border:1px solid #e2e8f0;border-radius:0.5rem;">' +
                        '<option value="1">Day 1</option><option value="2">Day 2</option><option value="3">Day 3</option>' +
                        '</select>' +
                        '</div>' +
                        '<div style="text-align:left;margin-bottom:12px;">' +
                        '<label style="font-size:12px;color:#64748b;font-weight:600;">Batch</label>' +
                        '<select id="swalBatch" class="swal2-select" style="width:100%;margin-top:5px;border:1px solid #e2e8f0;border-radius:0.5rem;">' +
                        '<option value="1">Batch 1</option><option value="2">Batch 2</option><option value="3">Batch 3</option>' +
                        '</select>' +
                        '</div>' +
                        '<div style="text-align:left;">' +
                        '<label style="font-size:12px;color:#64748b;font-weight:600;">Gymnast</label>' +
                        '<select id="swalGymnast" class="swal2-select" style="width:100%;margin-top:5px;border:1px solid #e2e8f0;border-radius:0.5rem;">' +
