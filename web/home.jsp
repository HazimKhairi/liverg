        ...
        <%@page import="com.connection.DBConnect" %>
            ...
            <head>
                ...
                <meta name="description"
                    content="LIVERG - Professional Rhythmic Gymnastics Scoring System for competitions worldwide">
            ...
            <body>
                ...
                <section class="hero-slider">
                    <div class="hero-slide"
                        style="background-image: url('registration/assets/img/curved-images/sport10.jpg');">
                        <div class="container position-relative">
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="liverg-hero-content animate-fade-in-up">
                                        <span class="liverg-badge liverg-badge-primary mb-3">Professional Scoring
                                            System</span>
                                        <h1>LIVERG Rhythmic Gymnastics Scoring System</h1>
                                        <p>The ultimate professional scoring platform for rhythmic gymnastics
                                            competitions. Real-time scoring, live results, and comprehensive event
                                            management.</p>
                                        <div class="d-flex gap-3 flex-wrap">
                                            <a href="publicDashboard.jsp" class="btn-liverg btn-liverg-primary">
                                                <i class="fas fa-play-circle"></i> View Live Scores
                                            </a>
                                            <a href="#features" class="btn-liverg btn-liverg-outline"
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                <div class="news-slide-content text-white">
                                    <span class="liverg-badge"
                                        style="background: rgba(233,30,140,0.2); color: #e91e8c;">Latest News</span>
                                    ...
                                    <p class="mt-3" style="opacity: 0.9; font-size: 1.1rem;">
                                        Professional rhythmic gymnastics scoring made simple. Our platform provides
                                        real-time scoring,
                            ...
                            <div class="col-lg-4">
                                <div class="calendar-sidebar">
                                    <span class="text-uppercase fw-bold"
                                        style="color: var(--primary-dark); letter-spacing: 0.1em;">Upcoming</span>
                            ...
                            <div class="col-lg-8">
                                <ul class="event-list">
                                    <% try { DBConnect db=new DBConnect(); Connection conn=db.getConnection(); String
                                        sql="SELECT * FROM EVENT WHERE eventDate >= CURDATE() ORDER BY eventDate ASC LIMIT 5"
                                        ; PreparedStatement pstmt=conn.prepareStatement(sql); ResultSet
                                        rs=pstmt.executeQuery(); boolean hasEvents=false; while(rs.next()) {
                                        hasEvents=true; %>
                                        <li class="event-item">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <p class="event-location"><i class="fas fa-map-marker-alt me-1"></i>
                                                        <%= rs.getString("eventVenue") !=null ?
                                                            rs.getString("eventVenue") : "Venue TBA" %>
                                                    </p>
                                                </div>
                                        ...
                                        <% } if(!hasEvents) { %>
                                            <li class="event-item">
                                                <div class="text-center py-4">
                                                    ...
                                                    <p class="text-muted">Check back soon for new rhythmic gymnastics
                                                        competitions</p>
                                                </div>
                                            </li>
                                            <% } rs.close(); pstmt.close(); conn.close(); } catch(Exception e) {
                                                ...
                                                <li class="event-item">
                                                    <div class="text-center py-4">
                                                        ...
                                                        <p class="text-muted">Please check back later for upcoming
                                                            competitions</p>
                                                    </div>
                                                </li>
                                                <% } %>
                ...
                <section class="liverg-section" id="features">
                    <div class="container">
                        <div class="section-header">
                            ...
                            <p class="section-subtitle">Everything you need to run professional gymnastics competitions
                            </p>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-3">
                                <div class="liverg-card h-100 text-center p-4">
                                    <div class="feature-icon mx-auto"
                                        style="background: linear-gradient(135deg, rgba(0,212,170,0.1), rgba(0,212,170,0.2));">
                                        <i class="fas fa-bolt" style="color: var(--accent-cyan);"></i>
                                    </div>
                                    <h5>Real-Time Scoring</h5>
                                    <p class="text-muted">Instant score updates with live broadcasting to all connected
                                        devices</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                                <div class="liverg-card h-100 text-center p-4">
                                    <div class="feature-icon mx-auto"
                                        style="background: linear-gradient(135deg, rgba(233,30,140,0.1), rgba(233,30,140,0.2));">
                                        <i class="fas fa-users" style="color: var(--accent-magenta);"></i>
                                    </div>
                                    <h5>Multi-Judge Panel</h5>
                                    <p class="text-muted">Support for complete jury panels with individual scoring
                                        screens</p>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-3">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="liverg-card h-100 text-center p-4">
                                    <div class="feature-icon mx-auto"
                                        style="background: linear-gradient(135deg, rgba(200,230,50,0.1), rgba(200,230,50,0.3));">
                            ...
                            <div class="col-lg-6">
                                <div class="news-featured">
                                    ...
                                    <div class="news-featured-content">
                                        <span class="liverg-badge"
                                            style="background: var(--accent-magenta); color: white;">Featured</span>
                                        <h3 class="mt-2">LIVERG System Now Available for International Events</h3>
                                        <p>Our scoring system has been approved for use in international gymnastics
                                            competitions...</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="news-card">
                                            <div class="news-card-body">
                                                ...
                                                <p>Major performance improvements for large-scale competitions with
                                                    hundreds of participants...</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <section class="liverg-section"
                    ...
                    <div class="container text-center">
                        ...
                        <div class="d-flex justify-content-center gap-3 flex-wrap">
                            ...
                            <a href="index.jsp" class="btn-liverg"
